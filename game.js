...
let countries = [
    { name: 'USA', x: 200, y: 300, color: 'blue', army: 100, production: 2, resources: 150 },
    { name: 'Germany', x: 600, y: 400, color: 'black', army: 100, production: 2, resources: 150 },
    { name: 'USSR', x: 1000, y: 250, color: 'red', army: 100, production: 2, resources: 150 }
];
...
function drawCountries() {
    ...
    countries.forEach(country => {
        ...
        // Draw army count
        ctx.fillStyle = 'white';
        ctx.fillText(`${country.name} (${Math.floor(country.army)})`, country.x, country.y + 50);
    });
}
...
function updateGame() {
    countries.forEach(country => {
        if (country.resources > 0) {
            ...
            country.resources -= country.production * 0.2;
        }
    });
    drawCountries();
...
// Click to attack another country
